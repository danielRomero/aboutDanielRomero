...
(function() {
  ...
  window.danielromero.ready = function() {
    ...
    $(window).scroll(function() {
      ...
      return $('#about #me #timeline ul li .timeline-badge:not(.year)').each(function(index, element) {
        var css_class, elem_class, header_elem, _i, _len, _ref;
  ...
  window.danielromero.skill_click = function(elem) {
    var css_class, elem_class, progress_bar, _i, _len, _ref;
    $('#about #me .progress').fadeIn('slow');
    css_class = '';
    _ref = elem.attr('class').split(/-| /);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      elem_class = _ref[_i];
      if (window.danielromero.css_classes.indexOf(elem_class) > 0) {
        css_class = elem_class;
    ...
    return progress_bar.addClass("progress-bar progress-bar-" + css_class + " progress-bar-striped active");
  };
