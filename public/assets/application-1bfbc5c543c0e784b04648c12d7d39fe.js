...
(function() {
  ...
  window.facebook.initialize = function() {
    return (function(d) {
      var id, js, ref;
      js = void 0;
      id = 'facebook-jssdk';
  ...
  window.facebook.logout = function() {
    FB.logout(function(response) {
      $.getScript('/clear_session.js');
    });
  };

  window.facebook.login = function() {
  ...
  window.facebook.get_picture = function() {
  ...
  window.facebook.get_profile = function() {
...
(function() {
  ...
  window.danielromero.scroll_to = function(elem) {
    return $("html, body").animate({
      scrollTop: elem.offset().top - 60
    }, 800);
  };

  window.danielromero.ready = function() {
    ...
    $('#about #me span.label.skill').on("click", function(event) {
      window.danielromero.skill_click($(this));
      if (typeof ga === "function") {
        ga('send', 'event', 'button', 'click', "skill " + ($(this).html()));
      }
    });
    $('#about #me .progress').on("click", function(event) {
      $(this).fadeOut();
      if (typeof ga === "function") {
        ga('send', 'event', 'button', 'click', 'progress bar');
      }
    });
    $(document).on('click', '#about #twitter ul.pager.tweet_pager li a', function() {
      if (typeof ga === "function") {
    ...
    $(window).scroll(function() {
      ...
      return $('#about #me #timeline ul li .timeline-badge:not(.year)').each(function(index, element) {
        var css_class, elem_class, header_elem, i, len, ref;
        header_elem = $('header#application_header .timeline-badge');
        if (parseInt(offset) < parseInt($('#about #me #timeline ul li .timeline-badge:not(.year)').first().offset().top) || parseInt(offset) > $('#twitter').offset().top) {
          header_elem.fadeOut();
    ...
    $('footer#application_footer nav.navbar.navbar-default ul.nav.navbar-nav.github_project_link li a').on("click", function(event) {
      if (typeof ga === "function") {
        ga('send', 'event', 'button', 'click', 'fork this project');
      }
    });
    return 'ul.nav.navbar-nav.navbar-center';
  };

  window.danielromero.soft_appear = function() {
    $('.daniel_romero .soft_appear').first().appear();
    $('.daniel_romero .soft_appear').on("appear", function(event, elem) {
      $(elem).find('.appear_elem').each(function(index, element) {
        return $(element).fadeIn(400, function() {
  ...
  window.danielromero.skill_click = function(elem) {
    var percent;
    percent = elem.attr('data-percent');
    window.danielromero.draw_skill_char(percent);
    $('#skill_canvas_percent').html(percent + "%");
    return $('#skill_canvas_caption').html(elem.html());
  };

  window.danielromero.draw_skill_char = function(percent) {
    ...
    return $('#skill_canvas').animateLayer('my_arc', {
      start: 0,
